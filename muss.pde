...
void setup(){
  ...
  tilesSound = new SoundFile[] {
                new SoundFile(this, "audio/do.wav"),
                new SoundFile(this, "audio/mi.wav"),
                new SoundFile(this, "audio/si.wav"),
                new SoundFile(this, "audio/sol.wav")
              };
  starsOn = 0;
  firstContact = true;
  usrTurn = false;
